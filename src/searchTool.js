...
import { searchEngines, maxSearchRetries, excludedDomains, cacheExpiration } from './tools/search_tool/config.js';
import { fetchContent } from './tools/search_tool/fetcher.js';
import { extractSearchResults, extractMainContent } from './tools/search_tool/parser.js';
import { retry, createCache, cleanWhitespace, isValidUrl } from './tools/search_tool/utils.js';

class SearchTool {
    constructor() {
        this.name = "search";
        this.description = "A tool to search the internet for up-to-date information.";
        this.usage = "[TOOL: search(query)] where 'query' is the search term.";
        this.parameters = {
            type: "object",
            properties: {
...
// Export an instance of the SearchTool
